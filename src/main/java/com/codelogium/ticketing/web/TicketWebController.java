...
public class TicketWebController {
    ...
    public TicketWebController(TicketService ticketService, TicketMapper ticketMapper, UserService userService) {
    ...
    public String showCreateTicketForm(Model model, Authentication authentication) {
        ...
        model.addAttribute("currentUserId", Long.valueOf(authentication.getName()));
